...
export async function POST(request: Request) {
  ...
  const mergedConfig: LLMConfig = {
    ...
    AZUREOPENAI_API_KEY: userConfig.AZUREOPENAI_API_KEY || existingConfig.AZUREOPENAI_API_KEY,
    AZUREOPENAI_API_VERSION: userConfig.AZUREOPENAI_API_VERSION || existingConfig.AZUREOPENAI_API_VERSION,
    AZUREOPENAI_MODEL: userConfig.AZUREOPENAI_MODEL || existingConfig.AZUREOPENAI_MODEL,
    AZUREOPENAI_URL: userConfig.AZUREOPENAI_URL || existingConfig.AZUREOPENAI_URL,
    AZUREOPENAI_DEPLOYMENT: userConfig.AZUREOPENAI_DEPLOYMENT || existingConfig.AZUREOPENAI_DEPLOYMENT,
